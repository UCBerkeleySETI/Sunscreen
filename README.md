...
**The full set of models, including spectra and magnitudes, generated by default with Sunscreen can be found here as a series of tar.gz files:**
http://blpd0.ssl.berkeley.edu/galaxy_spectra/
